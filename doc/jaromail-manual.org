...
To edit the addressbook in Jaro Mail the *abook* command is available
: $ jaro abook
...
: $ jaro list
Even more useful to interface with other addressbook software and
mobile phones, you can use the *export* and *import* functions to
transport your addressbook formatted as a series of
VCards[fn:vcard].
: $ jaro export
